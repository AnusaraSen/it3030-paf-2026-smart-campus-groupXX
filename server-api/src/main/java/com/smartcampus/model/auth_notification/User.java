package com.smartcampus.model.auth_notification;
...
public class User {
    ...
    public User(Long id, String firstName, String lastName, String email, String password, Role role, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
